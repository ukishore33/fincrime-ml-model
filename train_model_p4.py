...
def train():
    df = pd.read_csv("/home/claude/fincrimeml/paysim_data.csv")
    ...
    df.to_csv("/home/claude/fincrimeml/paysim_scored.csv", index=False)
    ...
    with open("/home/claude/fincrimeml/model_results.json", "w") as f:
